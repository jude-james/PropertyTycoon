...
public class Bank
{
    ...
    // to be honest now we know the bank has endless money, these methods might be pointless, and if so, the bank class may be
    // small enough to merge into the board class
